...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 dark:bg-gray-950 text-white transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="mb-6">
              ...
              <form className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-slate-800 dark:bg-gray-900 border border-slate-700 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder-gray-400 transition-colors duration-200"
                />
                <button
                  type="submit"
            ...
            <div className="flex space-x-4">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <a
                  key={label}
                  href={href}
                  className="p-2 bg-slate-800 dark:bg-gray-900 rounded-lg hover:bg-slate-700 dark:hover:bg-gray-800 transition-colors duration-200 group"
                  aria-label={label}
                >
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-slate-800 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center">
